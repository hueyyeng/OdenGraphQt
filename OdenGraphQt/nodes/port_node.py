...
from OdenGraphQt.qgraphics.node_port_in import PortInputNodeItem
from OdenGraphQt.qgraphics.node_port_out import PortOutputNodeItem


class PortInputNode(BaseNode):
    """
    The ``PortInputNode`` is the node that represents a input port from a
    :class:`OdenGraphQt.GroupNode` when expanded in a
    :class:`OdenGraphQt.SubGraph`.

    .. inheritance-diagram:: OdenGraphQt.nodes.port_node.PortInputNode
        :parts: 1
    ...
    def add_output(self, name='output', multi_output=True, display_name=True,
        ...
        """
        Warnings:
            This function is called by :meth:`OdenGraphQt.SubGraph.expand_group_node`
...
class PortOutputNode(BaseNode):
    ...
    .. inheritance-diagram:: OdenGraphQt.nodes.port_node.PortOutputNode
        :parts: 1
