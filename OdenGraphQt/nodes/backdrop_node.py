...
class BackdropNode(NodeObject):
    """
    The ``OdenGraphQt.BackdropNode`` class allows other node object to be
    nested inside, it's mainly good for grouping nodes together.

    .. inheritance-diagram:: OdenGraphQt.BackdropNode
    ...
    def nodes(self):
        ...
        Returns:
            list[OdenGraphQt.BaseNode]: list of node under the backdrop.
        """
