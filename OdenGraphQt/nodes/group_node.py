...
from OdenGraphQt.qgraphics.node_group import GroupNodeItem
...
class GroupNode(BaseNode):
    ...
    The ``OdenGraphQt.GroupNode`` class extends from the :class:`OdenGraphQt.BaseNode`
    class with the ability to nest other nodes inside of it.

    .. inheritance-diagram:: OdenGraphQt.GroupNode
