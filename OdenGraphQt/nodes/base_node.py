...
from OdenGraphQt.base.commands import NodeVisibleCmd, NodeWidgetVisibleCmd
from OdenGraphQt.base.node import NodeObject
from OdenGraphQt.base.port import Port
from OdenGraphQt.constants import NodePropWidgetEnum, PortTypeEnum
...
from OdenGraphQt.widgets.node_widgets import (
    NodeBaseWidget,
    NodeCheckBox,
    NodeComboBox,
    NodeLineEdit
...
class BaseNode(NodeObject):
    """
    The ``OdenGraphQt.BaseNode`` class is the base class for nodes that allows
    port connections from one node to another.

    .. inheritance-diagram:: OdenGraphQt.BaseNode
    ...
    def add_custom_widget(self, widget, widget_type=None, tab=None, **kwargs):
        ...
        Args:
            ...
            widget_type: widget flag to display in the
                ...
                (default: :attr:`OdenGraphQt.constants.NodePropWidgetEnum.HIDDEN`).
    ...
    def hide_widget(self, name: str, push_undo=True):
        """
    ...
    def show_widget(self, name: str, push_undo=True):
        """
    ...
    def add_input(self, name='input', multi_input=False, display_name=True,
        ...
        Returns:
            OdenGraphQt.Port: the created port object.
        """
    ...
    def input_ports(self):
        ...
        Returns:
            list[OdenGraphQt.Port]: node input ports.
        """
        return self._inputs
    ...
    def output_ports(self):
        ...
        Returns:
            list[OdenGraphQt.Port]: node output ports.
        """
    ...
    def set_input(self, index, port):
        ...
        Args:
            ...
            port (OdenGraphQt.Port): port object.
        """
    ...
    def add_accept_port_type(self, port: Port, port_type_data: dict):
        ...
        Args:
            port (OdenGraphQt.Port): port to assign constrain to.
    ...
    def add_reject_port_type(self, port, port_type_data):
        ...
        See Also:
            :meth:`OdenGraphQt.Port.rejected_port_types`
    ...
    def on_input_connected(self, in_port, out_port):
        ...
        *The default of this function does nothing re-implement if you require
        ...
        Args:
            in_port (OdenGraphQt.Port): source input port from this node.
            out_port (OdenGraphQt.Port): output port that connected to this node.
        """
        return
    ...
    def on_input_disconnected(self, in_port, out_port):
        ...
        *The default of this function does nothing re-implement if you require
        ...
        Args:
            in_port (OdenGraphQt.Port): source input port from this node.
            out_port (OdenGraphQt.Port): output port that was disconnected.
        """
        return
