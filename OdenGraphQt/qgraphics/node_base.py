...
from OdenGraphQt.qgraphics.node_overlay_disabled import XDisabledItem
from OdenGraphQt.qgraphics.node_text_item import NodeTextItem
from OdenGraphQt.qgraphics.port import PortItem, CustomPortItem
...
class NodeItem(AbstractNodeItem):
    ...
    def post_init(self, viewer, pos=None):
        ...
        Args:
            viewer (OdenGraphQt.widgets.viewer.NodeViewer): main viewer
    ...
    def post_init(self, viewer=None, pos=None):
        ...
        Args:
            viewer (OdenGraphQt.widgets.viewer.NodeViewer): not used
