...
__doc__ = """
| The :py:mod:`OdenGraphQt.constants` namespace contains variables and enums 
 used throughout the OdenGraphQt library.
"""

# ================================== PRIVATE ===================================

MIME_TYPE = 'OdenGraphQt/nodes'
URI_SCHEME = 'OdenGraphQt://'
URN_SCHEME = 'OdenGraphQt::'
...
class VersionEnum(Enum):
    ...
    :py:mod:`OdenGraphQt.constants.VersionEnum`
    """
...
class LayoutDirectionEnum(Enum):
    ...
    :py:mod:`OdenGraphQt.constants.ViewerLayoutEnum`
    """
...
class ViewerEnum(Enum):
    ...
    :py:mod:`OdenGraphQt.constants.ViewerEnum`
    """
...
class ViewerNavEnum(Enum):
    ...
    :py:mod:`OdenGraphQt.constants.ViewerNavEnum`
    """
...
class NodeEnum(Enum):
    """
    Node styling layout:
    :py:mod:`OdenGraphQt.constants.NodeEnum`
    """
    #: default node width.
    WIDTH = 160
    #: default node height.
...
class PortEnum(Enum):
    """
    Port styling layout:
    :py:mod:`OdenGraphQt.constants.PortEnum`
    """
    #: default port size.
    SIZE = 22.0
...
class PortTypeEnum(Enum):
    ...
    :py:mod:`OdenGraphQt.constants.PortTypeEnum`
    """
...
class PipeEnum(Enum):
    """
    Pipe styling layout:
    :py:mod:`OdenGraphQt.constants.PipeEnum`
    """
    #: default width.
    WIDTH = 1.2
    #: default color.
...
class PipeSlicerEnum(Enum):
    ...
    :py:mod:`OdenGraphQt.constants.PipeSlicerEnum`
    """
    #: default width.
    WIDTH = 1.5
    #: default color.
...
class PipeLayoutEnum(Enum):
    ...
    :py:mod:`OdenGraphQt.constants.PipeLayoutEnum`
    """
...
class NodePropWidgetEnum(Enum):
    """
    Mapping used for the :class:`OdenGraphQt.PropertiesBinWidget` to display a
    node property in the specified widget type.

    :py:mod:`OdenGraphQt.constants.NodePropWidgetEnum`
    """
    ...
    BUTTON = 20
    #: Node property represented with lineedit (with validator) and checkbox widget.
    LINEEDIT_VALIDATOR_CHECKBOX = 1001
