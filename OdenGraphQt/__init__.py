...
# -*- coding: utf-8 -*-
"""
**OdenGraphQt** is a node graph framework that can be implemented and re purposed
into applications that supports **PySide6**.

project: https://github.com/jchanvfx/OdenGraphQt
documentation: https://jchanvfx.github.io/OdenGraphQt/api/html/index.html
...
.. code-block:: python
    ...
    from OdenGraphQt import QtWidgets, NodeGraph, BaseNode
    ...
    if __name__ == '__main__':
        ...
        backdrop = graph.create_node('OdenGraphQt.nodes.Backdrop', name='Backdrop')
