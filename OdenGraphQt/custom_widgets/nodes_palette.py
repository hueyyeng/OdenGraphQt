...
class NodesPaletteWidget(QtWidgets.QWidget):
    """
    The :class:`OdenGraphQt.NodesPaletteWidget` is a widget for displaying all
    registered nodes from the node graph in a grid layout with this widget a
    user can create nodes by dragging and dropping.

    | *Implemented on OdenGraphQt:* ``v0.1.7``

    .. inheritance-diagram:: OdenGraphQt.NodesPaletteWidget
        :parts: 1
    ...
    .. code-block:: python
        ...
        from OdenGraphQt import NodeGraph, NodesPaletteWidget
