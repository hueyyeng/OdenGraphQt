...
class NodesTreeWidget(QtWidgets.QTreeWidget):
    """
    The :class:`OdenGraphQt.NodesTreeWidget` is a widget for displaying all
    registered nodes from the node graph with this widget a user can create
    nodes by dragging and dropping.

    .. inheritance-diagram:: OdenGraphQt.NodesTreeWidget
        :parts: 1
    ...
    .. code-block:: python
        ...
        from OdenGraphQt import NodeGraph, NodesTreeWidget
