...
from OdenGraphQt import BackdropNode
...
class _PortConnectionsContainer(QtWidgets.QWidget):
    ...
    def _on_focus_to_node(self, port):
        ...
        Args:
            port (OdenGraphQt.Port): connected port.
        """
        if port:
            node = port.node()
...
class NodePropEditorWidget(QtWidgets.QWidget):
    ...
    def _read_node(self, node):
        ...
        Args:
            node (OdenGraphQt.BaseNode): node class.
    ...
    def get_widget(self, name: str):
        ...
        Returns:
            OdenGraphQt.custom_widgets.properties_bin.prop_widgets_abstract.BaseProperty: property widget.
        """
        if name == 'name':
...
class PropertiesBinWidget(QtWidgets.QWidget):
    """
    The :class:`OdenGraphQt.PropertiesBinWidget` is a list widget for displaying
    and editing a nodes properties.

    .. inheritance-diagram:: OdenGraphQt.PropertiesBinWidget
        :parts: 1
    ...
    .. code-block:: python
        ...
        from OdenGraphQt import NodeGraph, PropertiesBinWidget
    ...
    See Also:
            :meth:`OdenGraphQt.BaseNode.add_custom_widget`,
            :meth:`OdenGraphQt.NodeObject.create_property`,
            :attr:`OdenGraphQt.constants.NodePropWidgetEnum`

    Args:
        parent (QtWidgets.QWidget): parent of the new widget.
        node_graph (OdenGraphQt.NodeGraph): node graph.
    """
    ...
    def remove_node(self, node):
        ...
        Args:
            node (str or OdenGraphQt.BaseNode): node id or node object.
        """
