...
from OdenGraphQt.errors import NodeMenuError
from OdenGraphQt.widgets.actions import BaseMenu, GraphAction, NodeAction
...
class NodeGraphMenu(object):
    ...
    .. inheritance-diagram:: OdenGraphQt.NodeGraphMenu
        :parts: 1
    ...
    def get_menu(self, name):
        ...
        Returns:
            OdenGraphQt.NodeGraphMenu: menu item.
        """
    ...
    def get_command(self, name):
        ...
        Returns:
            OdenGraphQt.NodeGraphCommand: context menu command.
        """
    ...
    def add_menu(self, name):
        ...
        Returns:
            OdenGraphQt.NodeGraphMenu: the appended menu item.
        """
...
class NodesMenu(NodeGraphMenu):
    ...
    .. inheritance-diagram:: OdenGraphQt.NodesMenu
        :parts: 1
...
class NodeGraphCommand(object):
    ...
    .. inheritance-diagram:: OdenGraphQt.NodeGraphCommand
        :parts: 1
