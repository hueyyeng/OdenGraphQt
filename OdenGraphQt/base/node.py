...
from OdenGraphQt.base.commands import PropertyChangedCmd
from OdenGraphQt.base.model import NodeModel
...
class NodeObject(object):
    """
    The ``OdenGraphQt.NodeObject`` class is the main base class that all
    nodes inherit from.

    .. inheritance-diagram:: OdenGraphQt.NodeObject

    Args:
        qgraphics_item (AbstractNodeItem): QGraphicsItem item used for drawing.
    """

    __identifier__ = 'OdenGraphQt.nodes'
    """
    ...
    def type_(cls):
        ...
        `eg.` ``"OdenGraphQt.nodes.NodeObject"``
    ...
    def graph(self):
        ...
        Returns:
            OdenGraphQt.NodeGraph: node graph instance.
        """
        return self._graph
    ...
    def view(self) -> AbstractNodeItem | NodeItem:
        ...
        Returns:
            OdenGraphQt.qgraphics.node_abstract.AbstractNodeItem: node item.
        """
        return self._view
    ...
    def set_view(self, item):
        ...
        Args:
            item (OdenGraphQt.qgraphics.node_abstract.AbstractNodeItem): node item.
        """
        if self._view:
            old_view = self._view
    ...
    def model(self):
        ...
        Returns:
            OdenGraphQt.base.model.NodeModel: node model object.
        """
        return self._model
    ...
    def set_model(self, model):
        ...
        Args:
            model (OdenGraphQt.base.model.NodeModel): node model object.
        """
        self._model = model
        self._model.type_ = self.type_
    ...
    def create_property(
        ...
        Args:
            ...
            items (list[str]): items used by widget type
                attr:`OdenGraphQt.constants.NodePropWidgetEnum.QCOMBO_BOX`
